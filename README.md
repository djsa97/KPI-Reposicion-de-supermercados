...
```text
dashboard_reposicion.py
```

En `App secrets`, cargá este bloque y reemplazá los valores con tu service account:
...
No subas el JSON al repositorio. En Streamlit Cloud el dashboard ya está preparado para leer estas credenciales desde `st.secrets`.
